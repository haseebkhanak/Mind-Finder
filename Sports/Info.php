<?php
 ...
 {   
     ...
     if ($_SERVER['REQUEST_METHOD'] === 'POST') 
     {
         ...
         $sql="UPDATE sports_result set Score='$score_1' where Email='$email'";
         ...
         if ($result) 
         {
             ...
             $sql = "SELECT details.Id, details.Name, sports_result.Score FROM details INNER JOIN sports_result ON details.Email = sports_result.email
